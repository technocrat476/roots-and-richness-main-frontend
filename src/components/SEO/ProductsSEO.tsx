...
const ProductsSEO = () => {
  ...
  return (
    <PageSEO
      ...
      keywords="wood-pressed oils online, buy natural oils, cold-pressed oils, organic oils india, mustard oil, groundnut oil, coconut oil, sesame oil, white sesame oil, tribal coffee, natural products online shopping"
      canonicalUrl="https://rootsandrichness.in/products"
      ogImage="https://rootsandrichness.in/og-products.png"
